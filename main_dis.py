...
parser.add_argument('--arch', '-a', metavar='ARCH', default='dis_only', choices=model_names,
...
def train(train_dataset, model, criterion, g_optimizer, f_optimizer, epoch):
    ...
    for batch_idx, data in enumerate(train_dataset):
        ...
        if batch_idx % args.print_freq == 0:
            ...
            print('L_cls: {:.4f} L_f: {:.4f} L_g: {:.4f}'.format
                  (L_cls.item(), L_f.item(), L_g.item()))  # .data[0]
