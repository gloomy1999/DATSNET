...
parser.add_argument('--arch', '-a', metavar='ARCH', default='source_only', choices=model_names,
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # plot graph
        x_vals, y_vals, x_label, y_label, legend = [], [cls_loss, val_acc], \
                                                   [], [], ["L_cls", "val_acc"]
        for i in range(len(legend)):
            if 'L_' in legend[i]:
